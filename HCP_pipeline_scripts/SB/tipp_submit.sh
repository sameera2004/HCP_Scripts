...
StudyFolder="/gpfs/scratch/sabeykoon/HCP_data/nyspi" # Location of Subject folders
...
matlab -nodisplay -r "tipp_nyspi('/gpfs/scratch/sabeykoon/HCP_data/nyspi'); quit" 2> "/gpfs/scratch/sabeykoon/HCP_data/outputs/Tipp_nyspi_error.log" 1> "/gpfs/scratch/sabeykoon/HCP_data/outputs/Tipp_nyspi_output.log"
