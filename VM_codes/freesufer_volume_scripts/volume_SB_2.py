...
#current_dir = "/mnt/hcp01/scR21/"

current_dir = raw_input("Please enter the current dir eg : /mnt/hcp01/scR21/  :  ")

x = raw_input(" Enter list of subject number  eg : [50058, 50067] ")
x = eval(x)
...
for i in x:
    u = str(i).strip()
    y.append(u)
    v = "GenericfMRIVolumeProcessingPipelineBatch_2_" + str(u) + ".sh"
    g.append(open(v,'w'))
    

for i in range(len(y)):
    # I added '/' after diff to volume_SB.py
